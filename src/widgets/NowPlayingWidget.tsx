  ...
  return (
    <FocusableCard className="flex h-full min-h-0 flex-col">
      <div className="mb-2 flex shrink-0 items-center gap-2">
        <Music size={18} strokeWidth={1.5} className="text-white/40" />
        <h2 className="font-display text-base font-medium tracking-wide text-white/60">
          Now Playing
        </h2>
      </div>

      <div className="mb-2 flex min-h-0 items-center gap-3">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600/40 to-fuchsia-600/40">
          <Music size={20} strokeWidth={1.5} className="text-white/60" />
        </div>
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-[clamp(0.7rem,0.8vw,0.85rem)] text-white/25">
            {track.album}
          </p>
        </div>
      </div>
      ...
      <div className="mt-auto shrink-0">
        <div className="mb-1.5 h-1 w-full overflow-hidden rounded-full bg-white/[0.08]">
          <div
            className="h-full rounded-full bg-gradient-to-r from-violet-500/80 to-fuchsia-500/60 transition-all duration-1000"
            style={{ width: `${progressPercent}%` }}
          />
        </div>
        <div className="mb-2 flex justify-between text-[clamp(0.65rem,0.75vw,0.8rem)] text-white/30">
